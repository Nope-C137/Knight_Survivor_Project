...
namespace TD
{
    public class PlayerAnimation : MonoBehaviour
    {
        ...
        private static int isRotatingToTaret = Animator.StringToHash("isRotateToTarget");
        ...
        private void UpdateAnimationState()
        {
            ...
            Vector2 inputTarget = isSprinting ? _playerLocomotionInput.MovementInput * 2f : isRunning ? _playerLocomotionInput.MovementInput * 1f : _playerLocomotionInput.MovementInput * 0.5f;
            _currentBlendInput = Vector3.Lerp(_currentBlendInput, inputTarget, locomotionBlendSpeed * Time.deltaTime);

            _animator.SetFloat(horizontalHash, _currentBlendInput.x);
            _animator.SetBool(isIdlingHash, isIdling);
            _animator.SetBool(isRotatingToTaret, _playerController.IsRotatingToTarget);
